...
Rather than manually weighting reconstruction against sparsity, SPALF minimizes $\ell_0$ sparsity subject to faithfulness, lexical drift, and orthogonality constraints. The system is solved via an **augmented Lagrangian with adaptive dual dynamics**.
